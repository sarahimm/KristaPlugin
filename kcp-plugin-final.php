...
function service_opps_form(){
        ...
        if ( empty( $_POST)){
            ...
            mail(get_bloginfo('admin_email'), 'New Service Opportunity Listing',"A new service opportunity listing
            is waiting for approval on the Krista Colleagues website. View it at ".get_post_permalink($postid),"From: ".get_bloginfo('admin_email'));
            return "Your suggestion has been submitted and is waiting for approval. Thank you!";
        }
}
